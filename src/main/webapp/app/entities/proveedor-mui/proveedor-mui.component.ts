...
@Component({
    selector: 'jhi-proveedor-mui',
    templateUrl: './proveedor-mui.component.html'
})
export class ProveedorMuiComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.proveedorService
            ...
            .subscribe(
                (res: HttpResponse<IProveedorMui[]>) => this.paginateProveedors(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/proveedor-mui'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IProveedorMui) {
        return item.id;
    }
    ...
    private paginateProveedors(data: IProveedorMui[], headers: HttpHeaders) {
