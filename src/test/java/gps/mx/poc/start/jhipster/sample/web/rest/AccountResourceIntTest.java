...
import gps.mx.poc.start.jhipster.sample.config.Constants;
...
import gps.mx.poc.start.jhipster.sample.repository.AuthorityRepository;
import gps.mx.poc.start.jhipster.sample.repository.PersistentTokenRepository;
import gps.mx.poc.start.jhipster.sample.repository.UserRepository;
import gps.mx.poc.start.jhipster.sample.security.AuthoritiesConstants;
import gps.mx.poc.start.jhipster.sample.service.MailService;
import gps.mx.poc.start.jhipster.sample.service.UserService;
import gps.mx.poc.start.jhipster.sample.service.dto.PasswordChangeDTO;
import gps.mx.poc.start.jhipster.sample.service.dto.UserDTO;
import gps.mx.poc.start.jhipster.sample.web.rest.errors.ExceptionTranslator;
import gps.mx.poc.start.jhipster.sample.web.rest.vm.KeyAndPasswordVM;
import gps.mx.poc.start.jhipster.sample.web.rest.vm.ManagedUserVM;
